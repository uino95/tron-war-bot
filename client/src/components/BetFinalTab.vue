        ...
        <v-card>
          ...
          <v-card-title primary-title class="justify-center">
            <v-form ref="form" v-model="valid" lazy-validation>
              ...
              <v-btn v-if="data.serverStatus == 200" :loading="isWaitingForConfirm" color="success" @click="placeBet">Bet {{betFinal.minBet}} {{currency}} {{currentCountry != null ?'on ' + universalMap(currentCountry):''}}</v-btn>
              <v-btn v-else-if="data.serverStatus == 300" color="info" @click="battleInProgress">Battle in progress...</v-btn>
              <v-btn v-else-if="data.serverStatus == 400" color="info" @click="payoutInProgress">Payout in progress...</v-btn>

                ...
                <v-card-text v-if="headerTile === 'How To Play'">
                    <ol style="text-align: justify">
                        <li>
                            ...
                            <a href="http://u6.gg/gmc5D" target="_blank">click here</a>.<br />
                            To play on mobile devices, please use
                        ...
                        <li>In order to play, you must own TRX: the underlying cryptocurrency of TRON’s network.</li>
                        <li>The BET AMOUNT is set to 50 TRX/1 WAR.</li>
                        <li>You can choose a different country for each bet (there is no limit of bets per-turn)</li>
                        <li>There is a turn every hour, and it is won by whoever placed the bet on the conqueror state.</li>
                    </ol>

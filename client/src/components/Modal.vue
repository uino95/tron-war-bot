  ...
  <v-dialog v-model="isVisible" max-width="500">
    <v-card>
      ...
      <v-card-text v-if="headerTile === 'How To Play'">
        ...
        Example: I think Japan will conquer another country in the next turn (doesn’t matter which one, you only care about the conqueror) so I choose Japan in the box “select country” and then I click “bet 50 TRX”.
        <br><br>
        The potential win is the 80% of the Jackpot and it is equally divided among the winners, the ones that have betted on the same country that has won in the turn.
        The Jackpot consists in the total amount of bets and is divided in this way: 80% to the winners, 10% is the starting jackpot of the next round and the 10% is taken by the team.
        When there isn’t a winner the 90% of the Jackpot will be the starting jackpot of the next round.
        <br><br>
        TronWarBot is not the owner of the WorldWarBot that runs the game, so it can’t control in any way the events.
        <br>
        Examples of the game:
        Example 1:
        10 people bet on Spain, Spain conquers England. The winners receive 0.8*(JACKPOT)/10.
        Example 2:
        Spain conquers England, but nobody bets on Spain. 0.9*(JACKPOT) will be the starting Jackpot of the next round (the 10% of jackpot is taken by the developers).
        <br><br>
        ...
        <v-expansion-panel class="mt-2 mb-2">
          <v-expansion-panel-content>
            <template v-slot:header data-icon="fa-info-circle">
              <div>Method A <v-chip color="green" text-color="white">Faster, more fees</v-chip>
              </div>
            </template>
            <v-card>
              <v-card-text>

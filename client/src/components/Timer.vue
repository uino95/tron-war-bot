<template>
  ...
  <div class="title " v-else> <b>Day {{this.info.turn}} in {{this.timerValue}} </b></div>
      ...
      updateTurnTimer: function () {
        ...
        if (this.info) {
          ...
          if (distance < 0) {
            ...
            this.timerValue = `${days} days ${hours} hours and ${minutes}:${seconds}`
          }
          else if(hours > 0){
            this.timerValue = `${hours} hours and ${minutes}:${seconds} `
          } else {

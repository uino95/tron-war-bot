...
module.exports = async function(deployer) {
  ...
  await twb.setGameParams(0, tronWrap.toSun(0.1), tronWrap.toSun(50), tronWrap.toSun(5000), {from: from});
  await twb.setGameParams(1, tronWrap.toSun(0.1), tronWrap.toSun(50), tronWrap.toSun(500), {from: from});
};
